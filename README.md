...
1.3 add one more `<div>`below this empty`<div>`-s and put inside 6 empty `<span>`tag and leave it.  ✅
1.4 below this div add 2 more`<div>`element with classes ✅
...
<div class="card">
  ...
  <div class="card-content">
    ...
    <p class="card-desc">
      Glowing purple broth with stardust spices. A local favorite in the Orion
      Belt.
    </p>
...
- **Ingredients:** Liquid Prism, Liquid Prism, Fermented Starfruit ✅
